...
class _NotificationsPageState extends State<NotificationsPage> {
  ...
  void _refreshNotifications() {
    ...
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(const SnackBar(content: Text('Refreshed notifications')));
  }
                ...
                child: Column(
                  ...
                  children: [
                    if (_notifications.isNotEmpty) ...[
                      ...
                      const SizedBox(
                        height: 3,
                      ), // SizedBox below the button for spacing
                    ] else
                      SizedBox(
                        width: 150,
                        height: 100,
        ...
        return Column(
          ...
          children: [
            ...
            ...notificationsForDate.map((notification) {
              ...
              return Dismissible(
                key: ValueKey(
                  notification.dateTime.toIso8601String() + notification.header,
                ),
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            // Illustration placeholder - replace with your own asset or widget
            SizedBox(
              height: 180,
              child: ClipRRect(
